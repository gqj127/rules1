...
# 获取有效 config.sh 链接
get_valid_config() {
    config_list=(https://ghproxy.com/https://raw.githubusercontent.com/yanyuwangluo/VIP/main/Conf/Qinglong/config.sample.sh)
...
# 获取有效 extra.sh 链接
get_valid_extra() {
    extra_list=(https://ghproxy.com/https://raw.githubusercontent.com/yanyuwangluo/VIP/main/Tasks/qlrepo/extra.sh)
...
# 获取有效 code.sh 链接
get_valid_code() {
    code_list=(https://ghproxy.com/https://raw.githubusercontent.com/yanyuwangluo/VIP/main/Scripts/sh/Helpcode2.8/code.sh)
...
get_valid_task_before() {
    task_before_list=(https://ghproxy.com/https://raw.githubusercontent.com/yanyuwangluo/VIP/main/Scripts/sh/Helpcode2.8/task_before.sh)
